...
const Mirror = () => (
  ...
  >
    ...
    <ParaWithHeaderLeft header="Ideation">
      I began the ideation phase by sketching out wireframes of the layout of
      the website after developing sitemaps and user flows. My ideas were
      solidified through user research and it allowed me to design a layout that
      would meet user expecttions and therefore alcasslow for a more positive
